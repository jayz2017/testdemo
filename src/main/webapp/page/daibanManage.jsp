...
<script type="text/javascript">
	...
	function formatAction(val,row){
		return "<a href='javascript:openFinishTaskTab("+row.id+")'>办理任务</a>&nbsp;<a target='_blank' href='${pageContext.request.contextPath}/History/showCurrentView.action?taskId="+row.id+"'>查看当前流程图</a>"
	}
	
	function openFinishTaskTab(taskId){
		$.post("${pageContext.request.contextPath}/taskExcute/redirectPage.action",{taskId:taskId},function(result){
...
<table id="dg" title="待办任务管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/History/findMyPersonalTask.action?assigneeRoleName=${currentMemberShip.role }" fit="true" toolbar="#tb">
 <thead>
 	<tr>
