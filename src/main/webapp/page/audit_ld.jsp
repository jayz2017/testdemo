...
<div id="p" class="easyui-panel" title="${sessionScope.currentMemberShip.group.name}审批" style="width: 700px;height: 280px;padding: 10px">
...
<table id="dg" title="批注列表" class="easyui-datagrid"
  fitColumns="true"
  url="${pageContext.request.contextPath}/task/listHistoryComment.do?taskId=${param.taskId}" style="width: 700px;height: 200px;">
 <thead>
 	<tr>
