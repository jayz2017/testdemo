...
<script type="text/javascript">
	...
	function formatAction(val,row){
		return "<a href='javascript:openListActionDialog("+row.id+")'>流程执行过程</a>&nbsp;<a href='javascript:openListCommentDialog("+row.id+")'>历史批注</a>&nbsp;<a target='_blank' href='${pageContext.request.contextPath}/History/showHistCurrentView.do?taskId="+row.id+"'>查看当前流程图</a>"
	}
...
<table id="dg" title="已办任务管理" class="easyui-datagrid"
  fitColumns="true" pagination="true" rownumbers="true"
  url="${pageContext.request.contextPath}/History/finishedList.action?groupId=${currentMemberShip.role}&userId=${currentMemberShip.staff_id }" fit="true" toolbar="#tb">
 <thead>
 	<tr>
...
<div id="dlg2" class="easyui-dialog" style="width: 750px;height: 250px;padding: 10px 20px" closed="true" >
  ...
  fitColumns="true"  
  url="${pageContext.request.contextPath}/History/listHistoryComment.do" style="width: 700px;height: 200px;">
 <thead>
 	<tr>
...
<div id="dlg3" class="easyui-dialog" style="width: 750px;height: 350px;padding: 10px 20px" closed="true" >
  ...
  fitColumns="true"  
  url="${pageContext.request.contextPath}/History/listAction.do" style="width: 700px;height: 250px;">
 <thead>
 	<tr>
