...
<script type="text/javascript">
	function searchProcessDefinition() {
	 ...
	 function formatAction(val,row){
		return "<a href='${pageContext.request.contextPath}/workflow/showView?deploymentId="+row.deploymentId+"&diagramResourceName="+row.diagramResourceName+"' target='_blank'>查看流程图</a>"
	}
</script>
</head>
<body style="margin: 1px">
	<table id="dg" title="流程定义管理" class="easyui-datagrid" fitColumns="true"
		...
		url="${pageContext.request.contextPath}/workflow/processDefinitionPage.action"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
