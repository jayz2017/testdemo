 ...
 <table style="padding: 5px;" width="100%">
 	<tr>
 		...
 		<td valign="bottom" align="right" width="50%">
 			<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>(${currentMemberShip.staff_name }${currentMemberShip.role})</font>
 		</td>
 	</tr>
 </table>
</div>
...
<div region="west" style="width: 200px;" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
	    <c:if test="${currentMemberShip.role=='ceo' }">
		...
		<c:if test="${currentMemberShip.role!='normal' and currentMemberShip.role!='ceo'}">
		...
		<c:if test="${currentMemberShip.role=='normal'}">
			<div title="业务管理"  data-options="iconCls:'icon-yewu'" style="padding:10px">
				<a href="javascript:openTab('请假申请','flowManage.jsp','icon-apply')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-apply'" style="width: 150px">流程申请</a>
			</div>
		</c:if>
