	...
	function submitData(){
		$("#fm").form("submit",{
			...
			success:function(result){
				...
				if(result.success){
					window.location.href="${pageContext.request.contextPath}/mian.jsp";
				}else{
...
<div class="easyui-window" title="workFlow_Demo" data-options="modal:true,closable:false,collapsible:false,minimizable:false,maximizable:false" style="width: 400px;height: 280px;padding: 10px">
